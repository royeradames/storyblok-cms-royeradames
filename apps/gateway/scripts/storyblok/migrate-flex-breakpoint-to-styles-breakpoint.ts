 ...
 *   bun run storyblok:migrate-flex-breakpoint-to-styles-breakpoint
 */
...
/**
 * Recursively walk content and mutate: for any object with component === OLD_COMPONENT,
 * set component = NEW_COMPONENT. Returns true if any change was made.
 */
