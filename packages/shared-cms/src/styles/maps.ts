...
/** Display labels for Border multi-select options: friendly name + px + Tailwind class for memorization. */
export const borderClassLabels: Record<keyof typeof borderClassMap, string> = {
  "border-0": "All (0px) (border-0)",
  border: "All (1px) (border)",
  "border-2": "All (2px) (border-2)",
  "border-4": "All (4px) (border-4)",
  "border-8": "All (8px) (border-8)",
  "border-x-0": "Left+Right (0px) (border-x-0)",
  "border-x": "Left+Right (1px) (border-x)",
  "border-x-2": "Left+Right (2px) (border-x-2)",
  "border-x-4": "Left+Right (4px) (border-x-4)",
  "border-x-8": "Left+Right (8px) (border-x-8)",
  "border-y-0": "Top+Bottom (0px) (border-y-0)",
  "border-y": "Top+Bottom (1px) (border-y)",
  "border-y-2": "Top+Bottom (2px) (border-y-2)",
  "border-y-4": "Top+Bottom (4px) (border-y-4)",
  "border-y-8": "Top+Bottom (8px) (border-y-8)",
  "border-s-0": "Start (0px) (border-s-0)",
  "border-s": "Start (1px) (border-s)",
  "border-s-2": "Start (2px) (border-s-2)",
  "border-s-4": "Start (4px) (border-s-4)",
  "border-s-8": "Start (8px) (border-s-8)",
  "border-e-0": "End (0px) (border-e-0)",
  "border-e": "End (1px) (border-e)",
  "border-e-2": "End (2px) (border-e-2)",
  "border-e-4": "End (4px) (border-e-4)",
  "border-e-8": "End (8px) (border-e-8)",
  "border-t-0": "Top (0px) (border-t-0)",
  "border-t": "Top (1px) (border-t)",
  "border-t-2": "Top (2px) (border-t-2)",
  "border-t-4": "Top (4px) (border-t-4)",
  "border-t-8": "Top (8px) (border-t-8)",
  "border-r-0": "Right (0px) (border-r-0)",
  "border-r": "Right (1px) (border-r)",
  "border-r-2": "Right (2px) (border-r-2)",
  "border-r-4": "Right (4px) (border-r-4)",
  "border-r-8": "Right (8px) (border-r-8)",
  "border-b-0": "Bottom (0px) (border-b-0)",
  "border-b": "Bottom (1px) (border-b)",
  "border-b-2": "Bottom (2px) (border-b-2)",
  "border-b-4": "Bottom (4px) (border-b-4)",
  "border-b-8": "Bottom (8px) (border-b-8)",
  "border-l-0": "Left (0px) (border-l-0)",
  "border-l": "Left (1px) (border-l)",
  "border-l-2": "Left (2px) (border-l-2)",
  "border-l-4": "Left (4px) (border-l-4)",
  "border-l-8": "Left (8px) (border-l-8)",
};
